...
<!-- Loading -->
<div id="wsf-form-add-loading">
	<div id="wsf-form-add-loading-backdrop"></div>
	<div id="wsf-form-add-loading-inner"><img src="<?php echo esc_attr(WS_FORM_PLUGIN_DIR_URL) . 'admin/images/loader.gif'; ?>" class="wsf-responsive" width="256" height="256" alt="<?php esc_html_e("Your form is being created...", 'ws-form'); ?>" /><p><?php esc_html_e("Your form is being created...", 'ws-form'); ?></p></div>
</div>
<!-- /Loading -->
