<?php
	...
	class WS_Form_Form extends WS_Form_Core {
		...
		public function get_svg_from_form_object($form_object, $label = false, $svg_width = false, $svg_height = false) {
			...
			$skin_color_secondary = WS_Form_Common::option_get('skin_color_secondary');
			$skin_color_success = WS_Form_Common::option_get('skin_color_success');
			$skin_color_success_light = WS_Form_Common::hex_lighten_percentage($skin_color_success, 40);
			$skin_color_success_lighter = WS_Form_Common::hex_lighten_percentage($skin_color_success, 85);
			$skin_color_success_dark = WS_Form_Common::hex_darken_percentage($skin_color_success, 40);
			$skin_color_information = WS_Form_Common::option_get('skin_color_information');
			$skin_color_information_light = WS_Form_Common::hex_lighten_percentage($skin_color_information, 40);
			$skin_color_information_lighter = WS_Form_Common::hex_lighten_percentage($skin_color_information, 85);
			$skin_color_information_dark = WS_Form_Common::hex_darken_percentage($skin_color_information, 40);
			$skin_color_warning = WS_Form_Common::option_get('skin_color_warning');
			$skin_color_warning_light = WS_Form_Common::hex_lighten_percentage($skin_color_warning, 40);
			$skin_color_warning_lighter = WS_Form_Common::hex_lighten_percentage($skin_color_warning, 85);
			$skin_color_warning_dark = WS_Form_Common::hex_darken_percentage($skin_color_warning, 40);
			$skin_color_danger = WS_Form_Common::option_get('skin_color_danger');
			$skin_color_danger_light = WS_Form_Common::hex_lighten_percentage($skin_color_danger, 40);
			$skin_color_danger_lighter = WS_Form_Common::hex_lighten_percentage($skin_color_danger, 85);
			$skin_color_danger_dark = WS_Form_Common::hex_darken_percentage($skin_color_danger, 40);

			$skin_font_family = WS_Form_Common::option_get('skin_font_family');
			$skin_font_size = (floatval(WS_Form_Common::option_get('skin_font_size')) / 2);
			$skin_font_size_large = (floatval(WS_Form_Common::option_get('skin_font_size_large')) / 2);
			$skin_font_size_small = (floatval(WS_Form_Common::option_get('skin_font_size_small')) / 2);
			$skin_font_weight = WS_Form_Common::option_get('skin_font_weight');

			$skin_border_width = floatval(WS_Form_Common::option_get('skin_border_width'));
			if($skin_border_width > 0) { $skin_border_width = ($skin_border_width / 2); }
			...
			foreach($fields as $field) {
				...
				if(is_rtl()) {
					...
					$label_inside_x = $label_x - (($skin_border_width * 2) + (($field_height - $label_font_size) / 2));
				...
				if(isset($field_type_buttons[$field['type']])) {
					...
					switch($class_field_button_type) {
						...
						case 'primary' :
							...
							$button_fill = $skin_color_primary;
							$button_fill_label = $skin_color_default_inverted;
							break;

						case 'secondary' :

							$button_fill = $skin_color_secondary;
							$button_fill_label = $skin_color_default_inverted;
							break;

						case 'success' :

							$button_fill = $skin_color_success;
							$button_fill_label = $skin_color_default_inverted;
							break;

						case 'information' :

							$button_fill = $skin_color_information;
							$button_fill_label = $skin_color_default;
							break;

						case 'warning' :

							$button_fill = $skin_color_warning;
							$button_fill_label = $skin_color_default;
							break;

						case 'danger' :

							$button_fill = $skin_color_danger;
							$button_fill_label = $skin_color_default_inverted;
							break;
					}
					...
					$svg_field = '<rect x="' . $field_x . '" y="0" fill="' . $skin_color_default_inverted . '" stroke="' . $skin_color_default_lighter . '" stroke-width="' . $skin_border_width . '" stroke-dasharray="2 1" rx="' . $skin_border_radius . '" width="' . $field_width . '" height="' . $field_height . '"/>';

					// Price Span - Label
					$svg_field .= '<text fill="' . $skin_color_default . '" transform="translate(' . $label_inside_x . ',' . $label_inside_y . ')" class="wsf-template-label">' . $field['label'] . '</text>';
					...
					if($label_render) {
						...
						$svg_field = '<text fill="' . $skin_color_default . '" transform="translate(' . ($label_x + $label_offset_x) . ',' . $label_font_size . ')" class="wsf-template-label">' . $field['label'] . ($field['required'] ? '<tspan fill="' . $skin_color_danger . '"> *</tspan>' : '') . '</text>';
					...
					switch($field['type']) {
						...
						case 'section_label' :
							...
							// Legend
							$svg_field = '<text fill="' . $skin_color_default . '" transform="translate(' . ($offset_x) . ',' . $legend_font_size . ')" class="wsf-template-legend">' . $field['label'] . '</text>';
						...
						case 'progress' :
							...
							$svg_field .= '<rect x="' . $field_x . '" y="' . $label_offset_y . '" fill="' . $skin_color_default_lighter . '" stroke="' . $skin_color_default_lighter . '" stroke-width="' . $skin_border_width . '" rx="' . $skin_border_radius . '" width="' . $field_width . '" height="' . ($field_height / 2) . '"/>';

							// Progress - Rectangle - Inner
							$svg_field .= '<rect x="' . (is_rtl() ? ($field_x + $field_width - $progress_width) : $field_x) . '" y="' . $label_offset_y . '" fill="' . $skin_color_primary . '" stroke="' . $skin_color_primary . '" stroke-width="' . $skin_border_width . '" rx="' . $skin_border_radius . '" width="' . $progress_width . '" height="' . ($field_height / 2) . '"/>';
						...
						case 'message' :
							...
							$message_fill_var = sprintf('skin_color_%s_lighter', $class_field_message_type);
							$message_fill_left_var = sprintf('skin_color_%s_light', $class_field_message_type);
							$message_fill_label_var = sprintf('skin_color_%s_dark', $class_field_message_type);

							$message_fill = $$message_fill_var;
							$message_fill_left = $$message_fill_left_var;
							$message_fill_label = $$message_fill_label_var;

							// Message - Rectangle
							$svg_field = '<rect x="' . $field_x . '" y="0" fill="' . $message_fill . '" rx="' . $skin_border_radius . '" width="' . $field_width . '" height="' . $field_height . '"/>';
							$svg_field .= '<rect x="' . $field_x . '" y="0" fill="' . $message_fill_left . '" rx="' . $skin_border_radius . '" width="' . ($skin_border_width * 2) . '" height="' . $field_height . '"/>';
						...
						case 'textarea' :
							...
							// Textarea - Rectangle
							$svg_field .= '<rect x="' . $field_x . '" y="' . $label_offset_y . '" fill="' . $skin_color_default_inverted . '" stroke="' . $skin_color_default_lighter . '" stroke-width="' . $skin_border_width . '" rx="' . $skin_border_radius . '" width="' . $field_width . '" height="' . ($field_height * 2) . '"/>';
						...
						case 'html' :
							...
							// Rectangle
							$svg_field .= '<rect x="' . $field_x . '" y="' . $label_offset_y . '" fill="' . $skin_color_default_inverted . '" stroke="' . $skin_color_default_lighter . '" stroke-width="' . $skin_border_width . '" stroke-dasharray="2 1" rx="' . $skin_border_radius . '" width="' . $field_width . '" height="' . ($field_height * 2) . '"/>';
						...
						case 'divider' :
							...
							// Divider - Line
							$svg_field .= '<line x1="' . $field_x . '" x2="' . ($field_x + $field_width) . '" y1="' . ($label_offset_y + ($field_height / 2)) . '" y2="' . ($label_offset_y + ($field_height / 2)) . '" stroke="' . $skin_color_default_lighter . '" stroke-width="' . $skin_border_width . '"/>';
						...
						case 'color' :
							...
							// Default - Rectangle
							$svg_field .= '<rect x="' . $field_x . '" y="' . $label_offset_y . '" fill="' . $skin_color_default_inverted . '" stroke="' . $skin_color_default_lighter . '" stroke-width="' . $skin_border_width . '" rx="' . $skin_border_radius . '" width="' . $field_width . '" height="' . $field_height . '"/>';

							// Color - Rectangle
							$svg_field .= '<rect x="' . $rect_x . '" y="' . $label_offset_y . '" fill="' . $rect_fill . '" stroke="' . $skin_color_default_lighter . '" stroke-width="' . $skin_border_width . '" rx="' . $skin_border_radius . '" width="' . $field_height . '" height="' . $field_height . '"/>';
						...
						case 'price_checkbox' :
							...
							// Checkbox - Rectangle
							$svg_field .= '<rect x="' . $rect_x . '" y="0" fill="' . $skin_color_default_inverted . '" stroke="' . $skin_color_default_lighter . '" stroke-width="' . $skin_border_width . '" rx="' . $skin_border_radius . '" width="' . $field_height . '" height="' . $field_height . '"/>';
						...
						case 'price_radio' :
							...
							// Radio - Circle
							$svg_field .= '<circle cx="' . $circle_x . '" cy="' . ($field_height / 2) . '" fill="' . $skin_color_default_inverted . '" stroke="' . $skin_color_default_lighter . '" stroke-width="' . $skin_border_width . '" r="' . ($field_height / 2) . '"/>';
						...
						case 'file' :
							...
							$svg_field .= '<rect x="' . $button_xpos . '" y="' . $label_offset_y . '" fill="' . $skin_color_default_lightest . '" stroke="' . $skin_color_default_lighter . '" stroke-width="' . $skin_border_width . '" rx="' . $skin_border_radius . '" width="' . $button_width . '" height="' . $field_height . '"/>';

							// File - Text - Button
							$svg_field .= '<text fill="' . $skin_color_default . '" transform="translate(' . $label_button_x . ' ' . ($label_offset_y + $label_inside_y) . ')" class="wsf-template-label" text-anchor="middle">Choose File</text>';
