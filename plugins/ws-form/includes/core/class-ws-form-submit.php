<?php
	...
	class WS_Form_Submit extends WS_Form_Core {
		...
		// Create CSV file
		public function db_export_csv(&$file, $submit_ids = array(), $status = '', $date_from = '', $date_to = '') {
		...
		function setup_from_post_section($section, $form_submit, $section_id = false, $section_repeatable_index = false, &$section_repeatable = array()) {
			...
			foreach($section_fields as $field) {
				...
				// Field required
				$field_required = WS_Form_Common::get_object_meta_value($field, 'required', false) && !in_array($field_name_post, $this->bypass_required_array);
